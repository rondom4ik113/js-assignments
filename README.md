...
## Javascript Assignments  [![Build Status](https://travis-ci.org/rondom4ik113/js-assignments.svg?branch=master)](https://travis-ci.org/rondom4ik113/js-assignments)
...
```
* Open https://github.com/rondom4ik113/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
