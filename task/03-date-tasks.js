...
function timeSpanToString(startDate, endDate) {
   ...
   result += (msec < 100 ? (msec < 10 ? '00' + msec : '0' + msec) : msec);
...
function angleBetweenClockHands(date) {
   ...
   let hourAngle = 0.5 * (60 * hours + min);
   ...
   let angleBetweenHandsInRadians = angleBetweenHands * Math.PI / 180;

   return angleBetweenHandsInRadians;
}
